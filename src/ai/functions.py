import numpy as np
from ai import cuda, utils
from ai.core_simple import Variable, as_array, as_variable, Function
...
def accuracy(y, t):
    ...
    result = pred == t.data
    acc = result.mean()
    return Variable(as_array(acc, cuda.get_array_module(acc)))
